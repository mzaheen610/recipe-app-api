...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 30,
            'price': Decimal('5.00'),
            'ingredients': [{'name': 'Lettuce'}, {'name':'Olive oil'}],
        }
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title='Chicken Chilly')
        r2 = create_recipe(user=self.user, title='Mutton Biriyani')
        ingredient1 = Ingredient.objects.create(user=self.user, name='Chicken')
        ingredient2 = Ingredient.objects.create(user=self.user, name='Mutton')

        r1.ingredients.add(ingredient1)
        r2.ingredients.add(ingredient2)
        r3 = create_recipe(user=self.user, title='Beef fry')
